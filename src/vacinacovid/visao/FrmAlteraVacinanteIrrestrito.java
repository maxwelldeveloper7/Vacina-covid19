 ...
 * @author maxwell
 */
public class FrmAlteraVacinanteIrrestrito extends JDialog {
    ...
    public FrmAlteraVacinanteIrrestrito(JFrame parent, boolean modal, String titulo,
    ...
    private void inicializarComponentesDaTela() {
        ...
        try {
            ...
            Logger.getLogger(FrmAlteraVacinanteIrrestrito.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void preencherCampos() {
        ...
        cbEsf.setSelectedItem(Controle.getVacinante().getAgente().getUbs().getNomeIniciaisMaiusculaSemSigla());
        System.out.println(Controle.getVacinante().getAgente().getUbs().getNomeIniciaisMaiusculaSemSigla());
        cbAcs.setSelectedItem(Utilidades.iniciaisMaiuscula(Controle.getVacinante().getAgente().getNome()));
    ...
    private void salvar(){      
        ...
        if(dao.update(v)){
            ...
            Controle.principalGestor.pesquisar(Controle.principalGestor.modelo, Controle.agenteSelecionada);
            limparFormulario();
            dispose();
