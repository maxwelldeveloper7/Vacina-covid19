 ...
 * @author maxwell
 */
public class FrmCadVacinante extends JDialog {
    ...
    public FrmCadVacinante(JFrame parent, boolean modal, String titulo,
    ...
    private void inicializarComponentesDaTela() {
        ...
        try {
            ...
            Logger.getLogger(FrmCadVacinante.class.getName()).log(Level.SEVERE, null, ex);
        }
